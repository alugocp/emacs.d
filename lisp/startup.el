...
(setq tab-line-tabs-buffer-group-sort-function							 ;; Makes tab order consistent
	(lambda () (string< (buffer-name a) (buffer-name b))))
...
(defun global-tab-switch (n)																		;; Switch to a numbered tab
	...
	(defvar buffers (buffer-list))
	(if (<= n (length buffers))
		(switch-to-buffer (nth ( - (length buffers) n) (mapcar #'buffer-name buffers)))
		nil))
...
(global-set-key (kbd "s-1") (lambda () (interactive) (global-tab-switch 1))) ;; Switch to tab 1
(global-set-key (kbd "s-2") (lambda () (interactive) (global-tab-switch 2))) ;; Switch to tab 2
(global-set-key (kbd "s-3") (lambda () (interactive) (global-tab-switch 3))) ;; Switch to tab 3
(global-set-key (kbd "s-4") (lambda () (interactive) (global-tab-switch 4))) ;; Switch to tab 4
(global-set-key (kbd "s-5") (lambda () (interactive) (global-tab-switch 5))) ;; Switch to tab 5
(global-set-key (kbd "s-6") (lambda () (interactive) (global-tab-switch 6))) ;; Switch to tab 6
(global-set-key (kbd "s-7") (lambda () (interactive) (global-tab-switch 7))) ;; Switch to tab 7
(global-set-key (kbd "s-8") (lambda () (interactive) (global-tab-switch 8))) ;; Switch to tab 8
(global-set-key (kbd "s-9") (lambda () (interactive) (global-tab-switch 9))) ;; Switch to tab 9

;; (setq-default tab-line-tabs-buffer-group-function (lambda () (seq-filter (lambda (b) (!= (buffer-file-name b) nil)) (tab-line-tabs-buffer-list))))
